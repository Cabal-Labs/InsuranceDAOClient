...
export default function Login() {
  ...
  return (
    <div className="page">
      <Box bg="blue.300" maxW={800} className="p-6" borderRadius="6px" width="50%" height="70%">
        ...
        <form onSubmit={(e) => {
          ...
          <Text color="white" htmlFor="hospitalName">Hospital Name:</Text>
          <input
            id="hospitalName"
            onChange={(e) => setHospitalName(e.target.value)}
            value={hospitalName}
            style={{ border: '2px solid white', borderRadius: '7px', marginBottom: '1rem', padding: '0.5rem', width: '100%', color: 'white', backgroundColor: 'transparent' }}
          />
          <Text color="white" htmlFor="hospitalName">Patient Address:</Text>
          <input
            id="patientAddress"
            ...
            style={{ border: '2px solid white', borderRadius: '7px', marginBottom: '1rem', padding: '0.5rem', width: '100%', color: 'white', backgroundColor: 'transparent' }}
          />
          <Text color="white" htmlFor="hospitalName">Medical Procedure:</Text>
          <input
            id="medicalProcedure"
            ...
            style={{ border: '2px solid white', borderRadius: '7px', marginBottom: '1rem', padding: '0.5rem', width: '100%', color: 'white', backgroundColor: 'transparent' }}
          />
          <Text color="white" htmlFor="hospitalName">Procedure Cost:</Text>
          <input
            ...
            style={{ border: '2px solid white', borderRadius: '7px', marginBottom: '1rem', padding: '0.5rem', width: '100%', color: 'white', backgroundColor: 'transparent' }}
          />
          <Button marginTop="2%" variant="primary" disabled={!write || isLoading}>
